...
def get_south_ray(bitboard: np.uint64, from_square: int) -> np.uint64:
    """Return all squares south of from_square on an empty board."""
    ...
    return clear_bit(bitboard, original_from_square)


def get_north_ray(bitboard: np.uint64, from_square: int) -> np.uint64:
    """Return all squares north of from_square on an empty board."""
    original_from_square = from_square
...
def get_west_ray(bitboard: np.uint64, from_square: int) -> np.uint64:
    """Return all squares west of from_square on an empty board."""
    original_from_square = from_square
...
def get_east_ray(bitboard: np.uint64, from_square: int) -> np.uint64:
    """Return all squares east of from_square on an empty board."""
    original_from_square = from_square
...
def get_southeast_ray(bitboard: np.uint64, from_square: int) -> np.uint64:
    """Return all squares southeast of from_square on an empty board."""
    original_from_square = from_square

    while 0 <= from_square < 64:
        bitboard |= HOT << np.uint64(from_square)

        if from_square % 8 == 7 or from_square < 8:
            break
...
def get_northwest_ray(bitboard: np.uint64, from_square: int) -> np.uint64:
    """Return all squares northwest of from_square on an empty board."""
    original_from_square = from_square

    while 0 <= from_square < 64:
        bitboard |= HOT << np.uint64(from_square)

        if from_square % 8 == 0 or from_square >= 56:
            break
...
def get_southwest_ray(bitboard: np.uint64, from_square: int) -> np.uint64:
    """Return all squares southwest of from_square on an empty board."""
    original_from_square = from_square

    while 0 <= from_square < 64:
        bitboard |= HOT << np.uint64(from_square)

        if from_square % 8 == 0 or from_square < 8:
            break
...
def get_northeast_ray(bitboard: np.uint64, from_square: int) -> np.uint64:
    """Return all squares northeast of from_square on an empty board."""
    original_from_square = from_square

    while 0 <= from_square < 64:
        bitboard |= HOT << np.uint64(from_square)

        if from_square % 8 == 7 or from_square >= 56:
            break
